...
DomainErrorTranslator._directories = {
  ...
  'ADDED_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat membuat added thread karena properti yang dibutuhkan tidak ada'
  ),
  'ADDED_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    'tidak dapat membuat added thread karena tipe data tidak sesuai'
  ),
  ...
  'ADDED_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat membuat added comment karena properti yang dibutuhkan tidak ada'
  ),
